...
$(document).ready(function() {
    ...
    retorno: '[font=Poppins][center][table style="border-color: black; border-radius: 10px; overflow: hidden; width: auto;" bgcolor="#4d4c4c"][tr][td][size=16][color=#ffffff][b]RETORNO DE LICENÇA / RESERVA[/b][/color][/size][/td][/tr][/table][/center][/font]\n[center][size=14][font=Poppins][b][color=black]{{nome}}[/color][/b][/font][/size][/center]',
